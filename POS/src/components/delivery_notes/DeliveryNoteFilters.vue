		...
		<div class="search-section">
			<div class="search-bar">
				...
				<input
					...
					type="text"
					class="search-input"
					:placeholder="__('Search delivery notes...')"
				/>
				<button
		...
		<Transition name="fade">
			<div v-if="store.hasActiveFilters" class="active-summary">
				<div class="summary-content">
					<TranslatedHTML 
						class="summary-text"
						:inner="__('&lt;strong&gt;{0}&lt;/strong&gt; of &lt;strong&gt;{1}&lt;/strong&gt; note(s)', 
...
import { DATE_PRESETS, STATUS_OPTIONS } from "@/composables/useDeliveryNoteFilters"
